...
All notable changes to `+tentacles-agentic-syllabus+` will be documented
in this file.
...
* feat: 7-tentacles — standalone repo, CRG Grade B

==== Fixed

* fix(ci): sync hypatia-scan.yml to canonical (413:
env.HOME+Phase-2+SARIF) (#2)

==== Documentation

* docs: add README stub (mark repo as deliberate reservation) (#1)
* docs: add me/ slot and flag README as in-evolution
